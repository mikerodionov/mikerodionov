# Mikhail Rodionov
### 🏗️ Senior Platform Engineer | Multi-Cloud Architect

Senior professional specializing in designing secure, highly automated **Internal Developer Platforms (IDPs)** and scalable multi-cloud infrastructure. I bridge the gap between complex architectural design and rapid, compliant software delivery in highly regulated sectors.
...
| Cloud Governance | Platform Engineering | DevSecOps & Observability |
| :--- | :--- | :--- |
| Landing Zones (CAF/AVM) | Kubernetes (AKS) Ecosystem | Shift-Left Security Integration |
| Infrastructure as Code (Terraform/Ansible) | CI/CD Pipelines & GitOps | Continuous Compliance (SOC2/HIPAA/GxP) |
| Policy-as-Code & RBAC | Multi-Cloud Architecture | Incident Management & Root Cause Analysis |
